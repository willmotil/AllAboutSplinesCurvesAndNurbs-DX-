...
public class Curve_ForMeshBsplineWeightTimed
{
    ...
    /// <summary>
    /// </summary>
    public Curve_ForMeshBsplineWeightTimed(Vector4[] controlPoints)
    {
    ...
    /// <summary>
    /// </summary>
    public Curve_ForMeshBsplineWeightTimed(Vector4[] controlPoints, int numOfVisualCurvatureSegmentPoints, bool closedControlPoints, bool uniformedCurve)
    {
    ...
    /// 
    /// </summary>
    public Curve_ForMeshBsplineWeightTimed(Vector4[] controlPoints, int numOfVisualCurvatureSegmentPoints, bool closedControlPoints, bool uniformedCurve, float globalWeight, bool showTangents)
    {
        _closedControlPoints = closedControlPoints;
        _uniformedCurve = uniformedCurve;
